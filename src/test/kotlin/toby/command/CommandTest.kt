...
interface CommandTest {
    ...
    companion object {
        @Mock
        val event: SlashCommandInteractionEvent = Mockito.mock(SlashCommandInteractionEvent::class.java)
    ...
    fun UserDto.getDiscordId() = discordId
    fun UserDto.getGuildId() = guildId
    fun UserDto.isSuperUser() = superUser
    fun UserDto.hasMemePermission() = memePermission
    fun UserDto.hasMusicPermission() = musicPermission
    fun UserDto.hasDigPermission() = digPermission
    fun UserDto.getMusicDto() = musicDto
