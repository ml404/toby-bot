...
import bot.toby.web.RedditAPIDto
...
class MemeCommand : IFetchCommand {
    ...
    private fun getRedditApiArgs(event: SlashCommandInteractionEvent): RedditApiArgs {
        ...
        val timePeriod = RedditAPIDto.TimePeriod.parseTimePeriod(event.getOption(TIME_PERIOD)?.asString ?: "day").timePeriod
    ...
    override val optionData: List<OptionData>
        get() {
            ...
            RedditAPIDto.TimePeriod.entries.forEach { tp -> timePeriod.addChoice(tp.timePeriod, tp.timePeriod) }
