...
interface CommandTest {
    ...
    companion object {
        ...
        val interactionHook: InteractionHook = mockk(relaxed = true)
        ...
        val requestingUserDto: database.dto.user.UserDto = mockk(relaxed = true)
        ...
        val restAction: RestAction<*> = mockk(relaxed = true)
        val guildVoiceState: GuildVoiceState = mockk(relaxed = true)
