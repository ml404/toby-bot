...
internal class UnlockCommandTest : CommandTest {
    ...
    fun test_UnlockRejectsMissingBotPermission() {
        ...
        every { member.hasPermission(textChannel, Permission.MANAGE_PERMISSIONS) } returns true
        every { botMember.hasPermission(textChannel, Permission.MANAGE_PERMISSIONS) } returns false
